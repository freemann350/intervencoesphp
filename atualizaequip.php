                  ...
                  <h5 class="centered">Admin</h5></a>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li class="active"><a href="atualizaequip.php" style="background: transparent;">Atualizar equipamento</a></li>
            ...
            <section class="wrapper site-min-height">
                ...
                <footer class="site-footer">
                    <div class="text-center">
                      ...
                      <span><a href="feedback.php" class="support"><u>Feedback/Suporte</u></a></span>
                    </div>
                </footer>
              </section>
            </section>
